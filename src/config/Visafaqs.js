...
export const visaFaqs = {
  ...
  // ---- One hero image per section (replace IELTSPreparation's URL — see note below) ----
  faqImages: {
    visaConsultation:
      "https://images.unsplash.com/photo-1556761175-b413da4baf72?auto=format&fit=crop&w=1200&q=80",
    PathwayPrograms:
  ...
  // ---- FAQ section heading/description per page — this is what you edit to "change title/description" ----
  faqMeta: {
    visaConsultation: {
      badgeText: "Visa Consultation FAQs",
      title: "Answers Before",
      highlightTitle: "Your Consultation",
      description:
        "Everything you need to know before booking your first session with a consultant.",
    },
    PathwayPrograms: {
      badgeText: "Pathway Programs FAQs",
      title: "Questions About",
      highlightTitle: "Pathway Programs",
      description:
        "How pathway routes work, who they're for, and how they lead into a full degree.",
    },
    ApplicationAndDocumentation: {
      badgeText: "Application & Documentation FAQs",
      title: "Get Your Documents",
      highlightTitle: "Application-Ready",
      description:
        "What's required, how to prepare it, and how we review your file before submission.",
    },
    IELTSPreparation: {
      badgeText: "IELTS Prep FAQs",
      title: "Questions About",
      highlightTitle: "IELTS Preparation",
      description:
        "How our coaching works, mock tests, and what band score you'll need.",
    },
    spouseandDependentVisa: {
      badgeText: "Spouse & Dependent Visa FAQs",
      title: "Bringing Family",
      highlightTitle: "Along With You",
      description:
        "Who qualifies as a dependent, what documents are needed, and work rights for spouses.",
    },
    visaInterviewPreparation: {
      badgeText: "Visa Interview FAQs",
      title: "Prepare For Your",
      highlightTitle: "Visa Interview",
      description:
        "Common interview questions, mock interviews, and how to answer with confidence.",
    },
    postStudyWorkVisa: {
      badgeText: "Post-Study Work Visa FAQs",
      title: "Work After",
      highlightTitle: "Your Studies",
      description:
        "Eligibility, duration, and how post-study work can factor into long-term plans.",
    },
    countryRequirements: {
      badgeText: "Country Requirements FAQs",
      title: "Compare Requirements",
      highlightTitle: "By Country",
      description:
        "Financial proof, documents, and English tests differ by destination — here's what to expect.",
    },
    PRDestinations: {
      badgeText: "PR Destinations FAQs",
      title: "Pathways To",
      highlightTitle: "Permanent Residency",
      description:
        "How post-study work and further criteria can factor into a PR pathway, country by country.",
    },
  },
};