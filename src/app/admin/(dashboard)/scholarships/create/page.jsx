    ...
    <div className="p-8">
      ...
      <div className="bg-white rounded-xl shadow-sm p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {/* University & Country */}
              <div>
                <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-4">University & Country</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-[var(--text-primary)] mb-2">
                      Country
              ...
              {/* Academic Details */}
              <div>
                <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-4">Academic Details</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-[var(--text-primary)] mb-2">
                      Degree Level
              ...
              {/* Funding */}
              <div>
                <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-4">Funding Information</h2>
              ...
              <div>
                <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-4">Requirements & Benefits</h2>
              ...
              {/* Application */}
              <div>
                <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-4">Application</h2>
                <div>
                  <label className="block text-sm font-medium text-[var(--text-primary)] mb-2">
                    Application URL
                  </label>
              ...
              {/* Image */}
              <div>
                <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-4">Image</h2>
                <div>
                  <label className="block text-sm font-medium text-[var(--text-primary)] mb-2">
                    Image URL
                  </label>
