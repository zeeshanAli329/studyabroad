  ...
  return (
    <main className="overflow-hidden bg-[#f8faf7] text-[var(--text-primary)]">
      ...
      <section className="relative px-4 pt-4 sm:px-6 lg:px-8">
        ...
        <div className="group relative min-h-[600px] overflow-hidden rounded-[32px] bg-emerald-950">
              ...
              {universities.slice(0, 6).map((university) => (
                ...
                >
                  ...
                  <div className="relative p-6">
                    ...
                    <h3 className="font-serif text-xl font-semibold leading-7 text-emerald-950 transition-colors group-hover:text-lime-600">
                      {university.name}
                    </h3>
