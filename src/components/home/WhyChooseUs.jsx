  ...
  const features = [
    {
      ...
      description:
        "Skilled professionals are always ready to provide reliable guidance and personalized support throughout your study-abroad journey.",
    },
    {
      icon: MapPin,
      title: "Our Presence",
      description:
        "Get dependable support from experienced consultants who understand international education, admissions, visas, and student travel.",
    },
  ];
          ...
          >
            <div className="relative">
              ...
              <p className="mb-8 max-w-2xl text-base leading-relaxed text-[var(--text-secondary)] sm:mb-10 sm:text-lg">
                ...
                achievable journeys. From choosing the right destination
                and university to visa guidance and pre-departure support,
