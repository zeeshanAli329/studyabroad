      ...
      <div className="relative z-10 mx-auto flex max-w-7xl flex-col items-start lg:px-5 gap-8 sm:gap-10 lg:flex-row lg:justify-between lg:items-center lg:gap-12">
        <div className="max-w-xl text-start lg:text-left">
          ...
          <div className="mt-8 flex flex-col items-start justify-start gap-4 sm:flex-row lg:justify-start">
            <Link
              href="/contact"
              className="group inline-flex items-center gap-2 rounded-full bg-[var(--primary)] px-8 py-4 text-sm font-semibold text-white transition-all duration-300 hover:bg-[var(--primary)] hover:gap-3"
            >
              Contact Us
