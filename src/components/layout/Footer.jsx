...
const Footer = () => {
  ...
  return (
    <footer
      ...
      aria-label={siteConfig.COMPANY_NAME}
    >
      {/* SEO Keywords / Semantic Information */}
      <div className="sr-only">
        {siteConfig.COMPANY_NAME} is an international education and visa consultancy helping
        students with student visas, work visas, tourist visas, business visas,
        international universities, {siteConfig.COMPANY_NAME} destinations, scholarships,
      ...
      >
          ...
          <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-5 lg:gap-8">
            ...
            <div>
              ...
              <p className="mb-5 max-w-[260px] text-[15px] leading-relaxed text-white/70">
                {siteConfig.COMPANY_NAME} provides professional {siteConfig.COMPANY_NAME}, visa
                consultancy, university admission, scholarship, and
                international education guidance for students worldwide.
              </p>
            ...
            <nav aria-label={siteConfig.COMPANY_NAME}>
              <h4 className="mb-5 font-serif text-lg font-semibold">
        ...
        <div className="relative z-10 border-t border-white/10">
          <div className="mx-auto flex max-w-[1320px] flex-col items-center justify-between gap-4 px-6 py-6 text-[14px] text-white/70 sm:flex-row lg:px-8">
            <p>
              Copyright © 2026 <strong>{siteConfig.COMPANY_NAME}</strong>. All Rights
              Reserved.
            </p>
