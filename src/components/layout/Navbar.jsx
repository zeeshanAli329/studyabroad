...
//         className={`fixed top-0 left-0 z-50 w-full transition-all duration-500 ${
//           sticky
//             ? "bg-[var(--secondary)]/90 backdrop-blur-md shadow-lg"
//             : "bg-white shadow-none"
//         }`}
//       >
//         {/* ================= DESKTOP HEIGHT ONLY ================= */}
//         <div className="mx-auto flex h-[90px] lg:h-[100px] max-w-[1320px] items-center justify-between px-6 lg:px-8">
//           {/* ================= LOGO (DYNAMICAL SWAPS ON SCROLL) ================= */}
//           <Link href="/" className="flex items-center shrink-0">
//             <img
//               src={sticky ? "/ch-logo2.png" : "/ch-logo.png"}
//               alt="Logo"
//               className="w-[125px] sm:w-[145px] lg:w-[200px] h-auto object-contain transition-all duration-300"
//             />
//           </Link>
...
//             <Link
//               href="/"
//               className={`text-[15px] font-serif font-bold uppercase transition ${
//                 sticky
...
//             >
//               <button
//                 className={`flex items-center gap-1.5 text-[15px] font-serif font-bold uppercase transition ${
//                   sticky
//                     ? "text-white hover:text-[var(--primary)]"
//                     : "text-[var(--primary-dark)] hover:text-[var(--primary)]"
//                 }`}
...
//               {blogOpen && (
//                 <div className="absolute top-full left-0 w-[220px] overflow-hidden rounded-xl bg-white/95 backdrop-blur-md shadow-xl border border-gray-100/50 pt-2">
//                   {blogLinks.map((item) => (
//                     <Link
//                       key={item.title}
//                       href={item.link}
...
//               {visaOpen && (
//                 <div className="absolute top-full left-0 w-[240px] rounded-2xl bg-white/95 backdrop-blur-md shadow-2xl border border-gray-100/50 overflow-hidden pt-2">
//                   {visaLinks.map((item) => (
//                     <Link
//                       key={item.title}
//                       href={item.link}
...
//           <button
//             onClick={() => setMenuOpen(true)}
//             className={`text-4xl lg:hidden transition ${
//               sticky ? "text-white" : "text-[var(--secondary)]"
//             }`}
//           >
//             <HiBars3 />
//           </button>
