...
//               <div className="inline-flex items-center gap-2 rounded-full border border-[var(--primary)]/20 bg-white px-3.5 py-2 text-[var(--primary)] font-semibold text-xs uppercase tracking-[0.14em] shadow-sm mb-5">
//                 <ShieldCheck className="w-4 h-4" />
//                 Student Visa Support
//               </div>

//               <h2 className="font-serif text-[var(--primary)] text-3xl sm:text-4xl lg:text-[2.7rem] font-semibold leading-[1.1] tracking-tight mb-5">
//                 Your Student Visa Journey,
//                 <span className="block text-[var(--primary)]">Guided With Confidence</span>
//               </h2>
...
//                   >
//                     <div className="w-9 h-9 rounded-xl bg-[var(--primary)] flex items-center justify-center mb-3">
//                       <item.icon className="w-4 h-4 text-[var(--primary)]" />
//                     </div>
//                     <h3 className="font-semibold text-[var(--primary)] text-sm mb-1">
//                       {item.title}
//                     </h3>
...
//               <div className="flex flex-wrap items-center gap-4 mt-7 pt-6 border-t border-[var(--primary)]/10">
//                 <div className="flex items-center gap-2 text-sm text-gray-600">
//                   <Globe className="w-4 h-4 text-[var(--primary)]" />
//                   <span>
//                     <strong className="text-[var(--primary)]">7+ destinations</strong>{" "}
//                     covered
//                   </span>
//                 </div>
...
//               <div className="relative rounded-[1.75rem] overflow-hidden bg-[var(--primary)] shadow-2xl">
//                 <img
...
//                 <div className="absolute inset-0 bg-gradient-to-t from-[var(--primary-dark)]/75 via-transparent to-transparent" />
...
//                     <div>
//                       <p className="text-xs font-semibold uppercase tracking-[0.14em] text-[var(--primary)] mb-1">
//                         Visa Guidance
//                       </p>
//                       <p className="font-serif text-[var(--primary)] text-lg font-semibold">
...
//               <div className="absolute -top-3 -right-3 sm:-top-5 sm:-right-5 rounded-2xl bg-[var(--primary)] text-white px-4 py-3 shadow-xl border-4 border-white">
//                 <p className="text-[var(--primary)] text-lg font-bold leading-none">7+</p>
        ...
        <div className="relative grid grid-cols-1 lg:grid-cols-[1.05fr_0.95fr] gap-8 lg:gap-12 items-center p-6 sm:p-8 lg:p-10">
          ...
          <div className="lg:pr-4">
            ...
            <h2 className="font-serif text-[var(--primary)] text-3xl sm:text-4xl lg:text-[2.7rem] font-semibold leading-[1.1] tracking-tight mb-5">
              {title}
              {highlightTitle && (
                <span className="block text-[var(--primary)]">{highlightTitle}</span>
              )}
            </h2>
